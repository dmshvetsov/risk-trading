...
export async function prepareUnderwrite(
  ...
  return Response.json({
    ...
    status: "pending",
    strikePriceDecimals: parsedBody.data.quote.strike_price_decimals,
